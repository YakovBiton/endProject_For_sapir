...
########################     ########################################
# classifier that only check the child to the father 
########################     ########################################

class ChildFaceFeaturesNet_Father(nn.Module):
    
    def __init__(self):
        super(ChildFaceFeaturesNet_Father, self).__init__()
...
model = ChildFaceFeaturesNet_Father()

def neural_Classifier_father(X , y ):
        ...
        torch.save(model.state_dict(), 'C://kobbi//endProject//py_torch_model//model_father.pth')
